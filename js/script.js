...
const equipmentData = [
    ...
    { id: 2, name: "Ski", image: "ski.jpg", available: 10, max: 10 },
    { id: 3, name: "Skøyter", image: "skates.jpg", available: 10, max: 10 },
    { id: 4, name: "Sko", image: "boots.jpg", available: 10, max: 10 },
    { id: 5, name: "Hjelm", image: "helmet.jpg", available: 10, max: 10 },
];

let cartCount = 0; // Antall varer i handlekurven

// Generer utstyrsliste
